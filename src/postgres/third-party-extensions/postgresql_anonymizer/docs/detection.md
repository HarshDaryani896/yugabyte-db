...
For instance, you can see the [english identifier dictionary] in file
`data/identifier_en_US.csv`.

[english identifier dictionary]: https://gitlab.com/dalibo/postgresql_anonymizer/-/blob/master/data/identifier_en_US.csv
